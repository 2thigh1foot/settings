...
export PATH=$PATH:/Users/admin/bin
...
# . "/Users/admin/anaconda3/etc/profile.d/conda.sh"  # commented out by conda initialize
        CONDA_CHANGEPS1=false conda activate base
    else
...
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/Users/admin/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/admin/anaconda3/etc/profile.d/conda.sh" ]; then
...
export GOPATH=/Users/admin/dev/Go
export PATH=$PATH:$GOPATH/bin
export GOPATH=$GOPATH:/Users/admin/dev/gocode
